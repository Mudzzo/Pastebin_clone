    ...
    <nav class="navbar navbar-expand-lg nav-bg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex justify-content-end align-items-center logout-container" action="logout.php"
                    method="POST">
                    <a class="p-1 mb-0 me-4 profile-link"
                        href="profile.php"><?php echo htmlspecialchars($_SESSION['FULL_NAME']);?></a>
